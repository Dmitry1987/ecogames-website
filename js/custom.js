...
$(document).ready(function(){
    $(".countdown").countdown("2018/01/01", function(event) {
        $(this).html(
            event.strftime(`
                <div class="col-md-3">
                    <h2 class="mb-10"><span class="days">%D</span></h2>
                    <h4 class="mb-0">Days</h4>
                    <div class="col-md-sep"><span>–</span></div>
                </div>
                <div class="col-md-3">
                    <h2 class="mb-10"><span class="hours">%H</span></h2>
                    <h4 class="mb-0">Hours</h4>
                    <div class="col-md-sep"><span>–</span></div>
                </div>
                <div class="col-md-3">
                    <h2 class="mb-10"><span class="minutes">%M</span></h2>
                    <h4 class="mb-0">Minutes</h4>
                    <div class="col-md-sep"><span>–</span></div>
                </div>
                <div class="col-md-3">
                    <h2 class="mb-10"><span class="seconds">%S</span></h2>
